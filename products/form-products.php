    ...
    <div class="container box-content">
        ...
        <div class="container row d-flex my-5">
            ...
            <div class="container text-center col-6 card-menu">
                ...
                <h2 class="color-title">Produtos</h2>
                ...
                <form>
                    <div class="mb-3 d-flex align-items-start flex-column">
                        ...
                        <input type="text" class="form-control" id="name" placeholder="Biscoito Treloso">
                    </div>
                    <div class="mb-3 d-flex align-items-start flex-column">
                        <label for="code" class="form-label color-title"><strong>Código de Barras</strong></label>
                        <input type="number" class="form-control" id="code" placeholder="000.000.000-00">
                    </div>
                    <div class="mb-3 d-flex align-items-start flex-column">
                        <label for="value" class="form-label color-title"><strong>Valor (Unidade)</strong></label>
                        <input type="text" class="form-control" id="value" aria-describedby="emailHelp" placeholder="R$ 1,50">
                    </div>
